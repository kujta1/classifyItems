...
#                     # Out-of-scope: ако ние не класифицираме во нашите класи
#         if predicted_class is None:
#             if labeled_category in self.classifier.classes_list:
#                 return False, "other", labeled_category, item  # требало да фати наша класа
#             else:
#                 return True, "other", "other", item  # и ние и ознаката се надвор

#         # Ако ние дадовме една од нашите класи:
#         if predicted_class in self.classifier.classes_list:
#             if labeled_category == predicted_class:
#                 return True, predicted_class, labeled_category, item  # точно
#             else:
#                 # човечката ознака е различна (или надвор)
#                 return False, predicted_class, labeled_category, item
